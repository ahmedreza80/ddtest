class WardrobesController < ApplicationController
  ...
  private
    ...
    def wardrobe_params
      params.require(:wardrobe).permit(:title, :description, :price, :image, :previewo, :previewt, :previewth, :sdescription, :offerprice, :coupon, :brand, :color, :warrenty, :material, :saving, :off, :height, :width, :depth, :dimension)
    end
end
