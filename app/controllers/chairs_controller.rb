class ChairsController < ApplicationController
  ...
  private
    ...
    def chair_params
      params.require(:chair).permit(:title, :description, :price, :image, :previewo, :previewt, :previewth, :sdescription, :offerprice, :coupon, :brand, :color, :warrenty, :material, :saving, :off, :height, :width, :depth, :dimension)
    end
end
