class BenchesController < ApplicationController
  ...
  private
    ...
    def bench_params
      params.require(:bench).permit(:title, :description, :price, :image, :previewo, :previewt, :previewth, :sdescription, :offerprice, :coupon, :brand, :color, :warrenty, :material, :saving, :off, :height, :width, :depth, :dimension)
    end
end
