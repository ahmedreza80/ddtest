class KidstudytsController < ApplicationController
  ...
  private
    ...
    def kidstudyt_params
      params.require(:kidstudyt).permit(:title, :description, :price, :image, :previewo, :previewt, :previewth, :sdescription, :offerprice, :coupon, :brand, :color, :warrenty, :material, :saving, :off)
    end
end
