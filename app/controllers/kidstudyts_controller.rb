class KidstudytsController < ApplicationController
  ...
  private
    ...
    def kidstudyt_params
      params.require(:kidstudyt).permit(:title, :description, :price, :image, :previewo, :previewt, :previewth, :sdescription, :offerprice, :coupon, :brand, :color, :warrenty, :material, :saving, :off, :height, :width, :depth, :dimension)
    end
end
