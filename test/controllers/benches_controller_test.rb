...
class BenchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bench" do
    assert_difference('Bench.count') do
      post benches_url, params: { bench: { description: @bench.description, price: @bench.price, title: @bench.title } }
    end
  ...
  test "should update bench" do
    patch bench_url(@bench), params: { bench: { description: @bench.description, price: @bench.price, title: @bench.title } }
