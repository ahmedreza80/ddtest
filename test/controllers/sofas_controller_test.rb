...
class SofasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sofa" do
    assert_difference('Sofa.count') do
      post sofas_url, params: { sofa: { description: @sofa.description, price: @sofa.price, title: @sofa.title } }
    end
  ...
  test "should update sofa" do
    patch sofa_url(@sofa), params: { sofa: { description: @sofa.description, price: @sofa.price, title: @sofa.title } }
