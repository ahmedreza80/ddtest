...
class ChairsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chair" do
    assert_difference('Chair.count') do
      post chairs_url, params: { chair: { description: @chair.description, price: @chair.price, title: @chair.title } }
    end
  ...
  test "should update chair" do
    patch chair_url(@chair), params: { chair: { description: @chair.description, price: @chair.price, title: @chair.title } }
